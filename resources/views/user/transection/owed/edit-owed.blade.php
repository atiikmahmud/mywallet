...
<div class="modal fade" id="owedEdit{{$data->id}}" tabindex="-1" aria-labelledby="owedEdit{{$data->id}}Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="owedEdit{{$data->id}}Label">Edit Your Owed</h1>
            ...
            <div class="modal-body">
                <div class="add-income-section">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('edit.owed') }}" method="POST">
                                @csrf
